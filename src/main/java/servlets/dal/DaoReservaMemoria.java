...
public class DaoReservaMemoria implements DaoReserva {
	...
	static {
		reservas.put(1L, new Reserva(1L, "Cliente", "cliente1@gmail.com", LocalDateTime.of(2022, 06, 29, 20, 0), 2, "Esto es una reserva del cliente 1"));
		reservas.put(2L, new Reserva(2L, "Cliente", "cliente2@gmail.com", LocalDateTime.of(2022, 07, 29, 21, 30), 1, "Esto es una reserva de un cliente 2"));
		reservas.put(3L, new Reserva(3L, "Cliente", "cliente2@gmail.com", LocalDateTime.of(2022, 02, 15, 16, 15), 3, "Esto es una reserva de un cliente 2"));
	}
